...
const orders = ordersJson as any[];

function get(req: { query: { buyer: any; }; }, res: any) {
...
async function post(req: { body: any; }, res: any) {
...
export default async function handler(req: any, res: { status: any }) {
  switch (req.method) {
    case "GET":
      get(req, res);
      break;
